...
<body>
    ...
    <section id="boardWrite">
        <div class="board__wrap container">
            <form action="boardModifySave.php">
                ...
                <div class="border_titleBox">
                    <?php
                        ...
                        if($result){
                            ...
                            echo "<div class='titleBox'><label for='boardTitle'>제목 : ".$info['boardTitle']."</label>";
                            echo "<input type='text' name='boardTitle' id='boardTitle' maxlength='30' required></div>";
                            ...
                            echo "<div class='imgAttachBox'><label for='boardImg'>Image</label><input type='file' name='boardImg' id='boardImg' accept='.jpg, .jpeg, .png, .gif, .webp' placeholder='jpg, jpeg, png, gif, webp 파일만 첨부해주세요.'></div>";
